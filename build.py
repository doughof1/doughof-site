...
def process_page():
    body='''<article class="process-page">
      ...
      <section class="process-band process-band--soft reveal"><div class="shell"><div class="process-stage__split"><div><p class="process-index">02 / Discovery</p><h2>Research and<br/>Discovery</h2></div><div><p>Once I understand the problem, I shift into research and discovery mode—searching for inspiration and analyzing competitors. I ask myself, <strong>“Is anyone else doing this?”</strong> and <strong>“How did they approach this problem?”</strong></p><p>I explore platforms like <a href="https://dribbble.com/doughof" target="_blank" rel="noreferrer">Dribbble</a>, Behance, and Pinterest, curating design collections for reference. Inspiration can come from small details, like mixed stroke weights in an icon, or larger elements, like color and typography choices. When solving a design problem, solutions appear everywhere, so I make it a priority to capture every idea, big or small.</p></div></div>
        <div class="process-gallery process-gallery--research"><figure><img src="/images/process/research-01.webp" alt="Research and visual inspiration board one" loading="lazy" /></figure><figure><img src="/images/process/research-02.webp" alt="Research and visual inspiration board two" loading="lazy" /></figure><figure><img src="/images/process/research-03.webp" alt="Research and visual inspiration board three" loading="lazy" /></figure><figure><img src="/images/process/research-04.webp" alt="Research and visual inspiration board four" loading="lazy" /></figure><figure><img src="/images/process/research-05.webp" alt="Research and visual inspiration board five" loading="lazy" /></figure><figure><img src="/images/process/research-06.webp" alt="Research and visual inspiration board six" loading="lazy" /></figure></div></div>
      </section>
      <section class="process-band process-band--red reveal"><div class="shell"><div class="process-stage__split"><div><p class="process-index">03 / Structure</p><h2>Wireframing</h2></div><div><p>Once I’ve got a solid foundation of inspiration, I dive into wireframing. It usually starts in my sketchbook before moving into Figma. I’ve used tools like Balsamiq and InVision in the past, but these days, I work faster in Figma with my wireframing component kit. This lets me create higher-fidelity compositions that fit seamlessly into my workflow.</p></div></div></div></section>
      <section class="process-stage shell reveal"><div class="process-gallery process-gallery--wireframes"><figure><img src="/images/process/wireframe-01.webp" alt="Mobile wireframe explorations" loading="lazy" /></figure><figure><img src="/images/process/wireframe-02.webp" alt="Desktop wireframe exploration" loading="lazy" /></figure><figure><img src="/images/process/wireframe-03.webp" alt="Mobile product wireframes" loading="lazy" /></figure></div></section>
      <section class="process-stage shell reveal"><div class="process-stage__split"><div><p class="process-index">04 / Interaction</p><h2>Prototyping</h2></div><div><p>Once the wireframes are finalized, I move into prototyping within Figma or Principle—experimenting with color palettes, element placement, and typography. If wireframes lay the foundation, prototypes bring the experience to life by organizing and refining interactions.</p><p>I try to move quickly during this phase because it’s easy to get caught up in small details and lose sight of the bigger problem we’re solving. A trick I picked up from <a href="https://www.draplin.com/" target="_blank" rel="noreferrer">James Draplin</a> is duplicating artboards as I build. This not only helps me track my own thought process but also makes it easier for others to follow along when giving feedback.</p></div></div>
        <div class="process-gallery process-gallery--prototypes"><figure><img src="/images/process/prototype-01.webp" alt="Prototype progression for a commerce experience" loading="lazy" /></figure><figure><img src="/images/process/prototype-02.webp" alt="Prototype progression for a game experience" loading="lazy" /></figure><figure><img src="/images/process/prototype-03.webp" alt="Prototype progression for live shopping" loading="lazy" /></figure><figure><img src="/images/process/prototype-04.webp" alt="Prototype and color-system exploration" loading="lazy" /></figure><figure><img src="/images/process/prototype-05.webp" alt="Prototype progression for a mobile ordering experience" loading="lazy" /></figure></div>
      </section>
      <section class="process-band process-band--dark reveal"><div class="shell process-stage__split"><div><p class="process-index">05 / Refinement</p><h2>Feedback, Iterate,<br/>Polish, Repeat.</h2></div><div><p>The final step in my design process is gathering feedback from stakeholders, then iterating, polishing, and repeating.</p><p>Developers jokingly call this “pushing pixels,” but I rather enjoy this stage. At this point, you’re so close to launching—refining and polishing the details before your solution goes live.</p><p>It feels like presentation day. You’re standing behind the curtain, moments away from unveiling your work to the world. It’s an exciting moment because, for better or worse, users will finally get to take your solution for a spin.</p></div></div></section>
    </article>'''
...
def project_page(p, idx):
    ...
    if p['slug'] == 'spin':
        pager = f'''<nav class="project-pager shell"><a href="/portfolio/{projects[idx-1]['slug']}/"><span>← Previous</span><strong>{esc(projects[idx-1]['title'])}</strong></a><a class="next" href="/portfolio/{projects[idx+1]['slug']}/"><span>Next →</span><strong>{esc(projects[idx+1]['title'])}</strong></a></nav>'''
        body = f'''<article class="case case-spin accent-page-orange">
          <header class="case-hero shell"><p class="kicker">Startup · Commerce · Live Video</p><h1>Spin Live Shopping</h1><p class="case-summary">Spin was a start-up for live streaming shopping, focusing on health and beauty product discovery and impulse buys. As the creative director, I helped build the company from the ground up, starting as a sketch in my notebook to an office space of over 15 people.</p>{meta}</header>
          <figure class="case-hero-image shell-wide"><img src="/images/spin/spin-hero.webp" alt="Spin Live Shopping mobile experience" /></figure>
          <section class="spin-copy shell reveal"><h2>Overview</h2><p>Spin represented a significant pivot from Gravy Live, the live shopping gameshow app we developed and nurtured for nearly three years. Drawing from our experiences with Gravy, we opted to concentrate on the health and beauty vertical. The design challenge was to transition all branding and aesthetics to reflect a new, softer look and feel with a predominantly female demographic.</p></section>
          <section class="spin-copy shell reveal"><h2>Why Pivot?</h2><p>The shift from tech products to beauty was influenced by several key factors:</p><ol><li>Beauty companies typically offer a greater number of SKUs compared to tech companies. This increase in variety translates to more content opportunities.</li><li>Health and beauty products tend to be smaller and less expensive to ship. Although shipping costs are often transferred to consumers, we had to absorb these costs, making it essential to keep shipping fees low.</li><li>Beauty products generally have higher profit margins than major tech items.</li></ol><p>With these challenges addressed, we could direct our efforts towards enhancing the consumer experience, improving host engagement, and sourcing better products.</p></section>
          <section class="spin-copy shell reveal"><h2>Design Thinking</h2><p>The foundation of my influence lies in the TikTok app and its ability to provide users with short-form videos from an apparently infinite source. I envisioned the app becoming more intelligent with increased usage, delivering content that is not only relevant to viewing habits and purchase history but also tailored to search queries.</p><p>To maintain a fresh and streamlined experience, I opted to replace traditional bottom-tab navigation with gesture-based interactions. Users can swipe up for the next product video, tap on product cards for additional details and purchasing options, swipe left to explore specific content, and swipe right to view the host’s profile, previous videos, followers, and social media accounts. Overall, the app prioritizes simplicity, catering to today’s consumers who seek immediate gratification.</p></section>
          <section class="spin-screen-stack shell-wide reveal">
            <figure><img src="/images/spin/screens-commerce.png" alt="Spin live shopping, product, and checkout screens" loading="lazy" /></figure>
            <figure><img src="/images/spin/screens-social.png" alt="Spin chat, sharing, and creator profile screens" loading="lazy" /></figure>
